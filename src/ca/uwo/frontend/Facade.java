...
public class Facade implements FacadeCommands {
	...
	public void placeOrder(Map<String, Integer> orderDetails, Buyer buyer) {
		...
		// Create order
		Order order1 = createOrder(orderDetails, buyer.getUserName());
		System.out.println("\tPlacing Order");
		// Deplete stock
		controller.depleteStock(order1);
		System.out.println("\tCreating Invoice");
		// Create invoice for order
		Invoice invoice1 = controller.createInvoice();
		// Receive payment from client
		bank.receivePayment(invoice1, buyer);
	...
	public void restock(Map<String, Integer> restockDetails, Supplier supplier) {
		...
		System.out.println("Facade: ");
		// Create the order
		Order restockOrder = createOrder(restockDetails, "Supplier");
